class SubcategoriesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @subcategory.save
        format.html { redirect_to @subcategory, notice: 'Подкатегория создана.' }
  ...
  def update
    respond_to do |format|
      if @subcategory.update(subcategory_params)
        format.html { redirect_to @subcategory, notice: 'Подкатегория изменена.' }
  ...
  def destroy
    @subcategory.destroy
    respond_to do |format|
      format.html { redirect_to categories_url, notice: 'Подкатегория удалена.' }
